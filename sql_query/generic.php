...
<body>
<h1>Google Visualisation API Query Language Playground</h1>
<form>
...
<p>* The number of the first sheet in a spreadsheet (which is used by default) is 0. To select thesecond sheet, add: 1; for the third sheet, add 2, and so on.</p>
</form>
<hr/>
<div id="headings"></div>
...
<h2>SQL Query</h2>
    <p>Use the table below to specify the SQL query in terms of column names A,B,C....</p>
